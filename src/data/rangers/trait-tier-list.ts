...
const data: TierListPageData = {
  ...
  tiers: [
    { name: "Mythic-Tier — Game-Changing Traits", description: "These two traits fundamentally alter how a unit plays. Extremely rare rolls but worth every Trait Roll you spend chasing them.", entries: [
