...
import data from "@/data/garden/best-mutations";

export const metadata: Metadata = {
  title: `${data.title} | BloxPulse`,
  description: data.description,
  keywords: ["Grow a Garden best mutations", "best mutations Grow a Garden", "mutation rolling guide", "mutation shard farming", "mutation strategy", "mutation boosted events"],
...
export default function BestMutationsPage() {
  return (
    <ContentLayout title={data.title} description={data.description} breadcrumbs={data.breadcrumbs} canonicalPath="/grow-a-garden/best-mutations" accent="garden" updatedAt={data.updatedAt}>
      ...
      <section aria-labelledby="overview-heading">
        <h2 id="overview-heading" className="font-heading text-[20px] font-semibold text-white lg:text-[24px] mb-4">🧬 Why Mutations Matter</h2>
      ...
      <section aria-labelledby="stages-heading">
        <h2 id="stages-heading" className="font-heading text-[20px] font-semibold text-white lg:text-[24px] mb-4">📈 Mutation Progression Roadmap</h2>
      ...
      <section aria-labelledby="resources-heading">
        <h2 id="resources-heading" className="font-heading text-[20px] font-semibold text-white lg:text-[24px] mb-4">🔮 Mutation Resources & Systems</h2>
      ...
      <section aria-labelledby="steps-heading">
        <h2 id="steps-heading" className="font-heading text-[20px] font-semibold text-white lg:text-[24px] mb-4">📋 Mutation Rolling Strategy</h2>
        <div className="rounded-xl border border-[#252936] bg-[#14161D] p-5">
      ...
      <section aria-labelledby="priority-heading">
        <h2 id="priority-heading" className="font-heading text-[20px] font-semibold text-white lg:text-[24px] mb-4">⭐ Mutation Priority Tier List</h2>
        <div className="overflow-hidden rounded-xl border border-[#252936]">
          <div className="grid grid-cols-[60px_1fr_2fr] gap-2 bg-[#1E212B] px-4 py-2.5 items-center">
            ...
            <span className="text-xs font-semibold text-[#768294]">STRATEGY / MUTATION</span>
      ...
      <section aria-labelledby="mistakes-heading">
        <h2 id="mistakes-heading" className="font-heading text-[20px] font-semibold text-white lg:text-[24px] mb-4">⚠️ Common Mutation Mistakes</h2>
